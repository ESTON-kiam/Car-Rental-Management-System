...
def updated(request):
    return render(request, 'customer/updated.html')
    ...
    for a in area:
        ...
        for car in vehicles:
            if car.is_available == True:
                vehicle_dictionary = {'name': car.car_name, 'color': car.color, 'id': car.id,
                                      'pincode': car.area.pincode, 'capacity': car.capacity,
...
def rent_vehicle(request):
    ...
    cost_per_day = int(vehicle.capacity) *1500
...
def confirm(request):
    ...
    if vehicle.is_available:
        ...
        rent = (int(vehicle.capacity)) * 1500* (int(days))
...
def edit_profile(request):
    ...
    if request.method == 'POST':
        ...
        return redirect('/customer_portal/updated/')
